...
public class Listing {
    ...
    @NotNull(message = "L'utilisateur trouveur est obligatoire")
    ...
    public Listing(String id, User finderUser, String title, ListingCategory category) {
        this.id = id;
    ...
    public User getFinderUser() {
        return finderUser;
    }

    public void setFinderUser(User finderUser) {
        this.finderUser = finderUser;
    }
    ...
    public boolean isResolved() {
        return status == ListingStatus.RESOLU;
    }
    ...
    public boolean equals(Object o) {
        ...
        return id != null && id.equals(listing.getId());
    }
